    ...
    <div class="row">
        <div class="col-md-12" ng-if="currentTerrain.photos.length > 0">
            <div ng-repeat="photo in currentTerrain.photos track by $index" class="col-md-4">
                <img src="@{{photo.location}}" alt="Poza" width="200" height="200" id="photo">
            </div>
        </div>
        ...
        <br>
        <div class="col-md-12" style="overflow: scroll;" ng-show="currentTerrain.newPhoto || currentTerrain.photos.length == 0">
            <div>
