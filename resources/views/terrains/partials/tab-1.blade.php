	...
	<div ng-if="terrains.length > 0" style="background: white;">
			<div class="terrain" ng-repeat="terrain in terrains | filter: { title: f_title}">
              <div class="item-teren">    
                  <div class="small-box-c1" style="cursor: pointer;" ng-click="editTerrain(terrain)"><a href="" class=""><div class="icon-edit"></div><span class="sup">@{{ terrain.title }}</span></a> </div>
                <div class="sup-lista small-box-zona">@{{ terrain.localitate }} Constanta</div>  
				<div class="sup-lista small-box-pret">3@{{ terrain.pret }} EURO</div>
