<div id="list" style="height: 93vh; overflow-y: scroll;width:420px;float:left" ng-cloak>
    <div ng-cloak>
        <ul class="nav nav-stacked" id="accordion1" ng-if="searchTerrains.length > 0" >
            <li class="rezultat" ng-repeat="terrain in searchTerrains track by $index"  ng-click="select(terrain)"> 
                ...
                <a class="title_search_link" href="#@{{terrain.id}}"><span class="check"></span> @{{terrain.title}} </a>
                <div id="@{{terrain.id}}">
